                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="#"
                                class="ml-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ml-2 dark:text-gray-400 dark:hover:text-white">{{ $product->title }}</a>
                        </div>
                    </li>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <div class="flex flex-warp -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <textarea name="description" id="description"
                                        class="block w-full bg-gray-200 text-gray-700  border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-none">{!! old('description') ?? $product->description !!}</textarea>
                                </div>
                            </div>
                            <div class="flex flex-warp -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <input type="number" placeholder="Product Price" value="{{ old('price') ?? $product->price }}"
                                        name="price"
                                        class="block w-full bg-gray-200 text-gray-700  border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-none">
                                </div>
                            </div>
                            <div class="flex flex-warp -mx-3 mb-6">
                                <div class="w-full px-3">
                                    ...
                                    <input type="number" placeholder="Quantity" value="{{ old('qty') ?? $product->qty }}"
                                        name="qty"
                                        class="block w-full bg-gray-200 text-gray-700  border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-none">
                                </div>
                            </div>
