                ...
                <div class="slider">
                        ...
                        @foreach ($products->galleries as $item)
                            <div class="px-2">
                                <div class="item {{ $loop->first ? 'selected' : '' }}"
                                    ...
                                    <img src="{{ Storage::url($item->url_image) }}" alt="front"
                    ...
                    <div class="preview">
                        <div class="item rounded-lg h-full overflow-hidden">
                            <img src="{{ $products->galleries()->exists() ? Storage::url($products->galleries->first()->url_image) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
                    ...
                    <div class="px-3 flex-none" style="width: 320px">
                        <div class="rounded-xl p-4 pb-8 relative bg-white">
                            <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                                <img src="{{ $recommendation->galleries()->exists() ? Storage::url($recommendation->galleries->first()->url_image) : 'data:image/gif;base64,R0lGODlhAQABAIAAAMLCwgAAACH5BAAAAAAALAAAAAABAAEAAAICRAEAOw==' }}"
